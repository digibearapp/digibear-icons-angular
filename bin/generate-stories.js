...
const { allNames } = require('../projects/db-icon/node_modules/@digibearapp/digibear-svg-icons');
...
function generateDbStories() {
    ...
    let fileLines = generateStoriesFileLines(imports, options);    createStoriesFile(fileLines);
}
